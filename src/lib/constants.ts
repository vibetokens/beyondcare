...
export const SERVICES = [
  { title: "Personal Care",          slug: "/services/personal-care",            desc: "Bathing, grooming, dressing, hygiene, and mobility support delivered with dignity.", icon: "Heart"           },
  { title: "Companion Care",         slug: "/services/companion-care",           desc: "Meaningful daily connection that combats isolation and keeps spirits up.",           icon: "Users"           },
  { title: "Respite Care",           slug: "/services/respite-care",             desc: "Planned relief for family caregivers — hours, days, or weekend coverage.",           icon: "RefreshCcw"      },
  { title: "Meal Preparation",       slug: "/services/meal-preparation",         desc: "Nutritious home-cooked meals built around preferences and dietary needs.",           icon: "UtensilsCrossed" },
  { title: "Transportation",         slug: "/services/transportation",           desc: "Reliable, safe rides to appointments, errands, and social activities.",              icon: "Car"             },
  { title: "Medication Reminders",   slug: "/services/medication-reminders",     desc: "Consistent on-schedule reminders so nothing gets missed.",                           icon: "Bell"            },
  { title: "Light Housekeeping",     slug: "/services/light-housekeeping",       desc: "Laundry, tidying, and household tasks that maintain a safe, clean home.",            icon: "Home"            },
  { title: "Hospital Discharge",     slug: "/services/hospital-discharge-support",desc:"Seamless care at home after surgery, rehab, or a hospital stay.",                   icon: "Activity"        },
  { title: "Mobility & Transfers",   slug: "/services/mobility-transfer-support",desc: "Safe assistance with movement, transfers, and fall prevention.",                     icon: "MoveHorizontal"  },
  { title: "Medication Management",  slug: "/services/medication-reminders",     desc: "Organized reminders aligned with prescribed schedules.",                             icon: "Pill"            },
  { title: "24-Hour Home Care",      slug: "/services/24-hour-home-care",        desc: "Around-the-clock in-home support for those who need continuous assistance.",         icon: "Clock"           },
  { title: "Overnight Care",         slug: "/services/overnight-care",           desc: "Nighttime monitoring and support for safety and peace of mind.",                     icon: "Moon"            },
];
